...
ks = LINETCR. LINE()
ka.login(token="Eo7AZ7ZnoswvM5e1VYea.DHeHozIH2dDZH7qBMF5JwG.ixhvN+b/Jplh+EPLzMYNdo1/S1HYMc65OoLNMK/r174=")
ks.loginResult()
          ...
          if wait["Protectgr"] == True:
            if cl.getGroup(op.param1).preventJoinByTicket == False:
              if op.param2 in Bots:
                ...
                try:
                  cl.sendText(op.param1,cl.getContact(op.param2).displayName + "Jangan buka QR Bro")
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    msg.contentMetadata = {'mid': mid}
                    cl.sendMessage(msg)
                    cl.sendText(msg.to,"salam satu jiwa wani")
                    targets = []
                    for g in gs.members:
