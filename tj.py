...
cl.login(token="EorVdvohzyerSurc9IV0.2247eODILz04klZWD4T78a.7M7MIEpiXR1cwMwek/mXongX9eVEZHxeqypji7w3Q9g=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="EoFxuIHIQQKupnarp6d7.ydbWO6RI0lXwb5cAALoMfW.ux/psUa5o2Kz3s5Ag++b8OshRwCEfw0lOPjNlt9T6Z4=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="EoNf81xtxKAbDlk8Y996.xp+F+955ZJ52/D+jPSnjHG.crjfrWTaVkkuzTwgF666iqy4gphWmhBs/ZNXjeVtUa8=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="EoAmUMZlV3uhA0xNNyE2.6qP7wxDr/icxSov6HIJlOG.K7QEFRz1Y5ScOmxsZa+j+JoN2V/vbiFAc2RezETXHIk=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="EoTUe154av5OvcsXYsp2.dgYWt8es393tPMWTlHCRaG.n2ySI4yuzFq0g/o8Mu4o+ZSyXx2zAUrIYOuith9SpDA=")
ks.loginResult()

ka = LINETCR.LINE() #Franky
ka.login(token=" Eo25iUUpFtcSM1Nlp5y6.OsmTA4zIXh1LxjgYbUWI9G.98xQ18RrJfNMDEMy6+Ul+0rHwek7PbqQPKh8YXDIC1g=")
ka.loginResult()
...
admin=["udb6e3b128762959d3828bcf0778b7bf0"] 
owner=["udb6e3b128762959d3828bcf0778b7bf0"]
whitelist=[" "]
wait = {
    'contact':False,
    'autoJoin':True,
            ...
            if cl.getGroup(op.param1).preventJoinByTicket == False:
              if op.param2 in Bots:
                ...
                try:
                  ...
                  random.choice(KAC).sendText(op.param1,random.choice(KAC).getContact(op.param2).displayName + "jangan buka Link Group Bro")
  ...
  #------Joined User Kick start------#
    ...
    #--------------- Lawan atau Whitelist -------
              ...
              if whitelist == []:
                  ...
                  #cl.sendText(msg.to,"Tunggu...")
                  mc = "🛂Whitelist Rangers bots team🛃\n𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓\n"
                ...
                wait2['ROM'][msg.to] = {}
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "╔═════════════\n║👀Seen By👀%s\n╠═════[Result]═════\n║👀The Siders👀\n%s║Nah.....looooo ketahuankan\n║[%s]\n╚═════════════" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Type Cctv First Dude\nThen Type Ciduk\nDasar Pikun ♪")
        #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Come","Masuk","Bot in"]:
              if msg.from_ in owner:
    ...
    #-------------Fungsi Tag All Finish---------------#
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Rangers out","Rangers bye"]:
              if msg.from_ in owner:
                #gid = cl.getGroupIdsJoined()
                gid = ki.getGroupIdsJoined()
                gid = kk.getGroupIdsJoined()
...
#------------------------End---------------------
 ...
 #-----------------End-----------
            elif msg.text in ["Tampan"]:
              if msg.from_ in owner:
                ki.sendText(msg.to,"Siapa")
                kk.sendText(msg.to,"Siapa")
                kc.sendText(msg.to,"creatornya lah😁😁😁􏿿")
#-----------------------------------------------
            elif msg.text in ["Welcome"]:
...
#-----------------------------------------------
              ...
              if msg.from_ in owner:
                cl.sendText(msg.to,"Kok iya melulu kak😎􏿿")
#-----------------------------------------------

       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Absen","Absen bot","Absen dulu","Respon"]:
              if msg.from_ in admin:
                cl.sendText(msg.to,"Tunjukan pesonamu")
                ki.sendText(msg.to,"❇")
                kk.sendText(msg.to,"❇❇")
                kc.sendText(msg.to,"❇❇❇")
                ks.sendText(msg.to,"❇❇❇❇❇")
                ka.sendText(msg.to,"❇❇❇❇❇❇")
                cl.sendText(msg.to,"Kami siap Mengayomi&Melindungi")
    #-------------Fungsi Respon Finish---------------------#   
            elif msg.text in ["Invite"]:
              if msg.from_ in owner:
                wait["winvite"] = True
                cl.sendText(msg.to,"kirim kontak cruttt 💾")
                
            elif msg.text in ["2invite"]:
              if msg.from_ in owner:
                wait["winvite2"] = True
                ki.sendText(msg.to,"kirim kontak cruttt💾")
                
            elif msg.text in ["3invite"]:
              if msg.from_ in owner:
                wait["winvite3"] = True
                kk.sendText(msg.to,"kirim kontak cruttt💾")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              quote = ['Ada yg perlu dibantai kak'] 
    ...
    #-------------Fungsi Bannlist Finish------------------#  
            ...
            elif 'Goyang ' in msg.text.lower():
              if msg.from_ in admin:
                try:
                    songname = msg.text.lower().replace('Goyang ','')
                    params = {'songname': songname}
                    r = requests.get('http://ide.fdlrcn.com/workspace/yumi-apis/joox?' + urllib.urlencode(params))
                    data = r.text
                    data = json.loads(data)
