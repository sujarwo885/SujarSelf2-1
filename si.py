...
ka.token="EncQD9YYLBa539ZRAA70.9JVR7bM9MS8pI0+G7+H/ea.wDLwWva56y5vX1k8A0i/06iTQzy2CsYfqndFCUFhX+M=")
ka.loginResult()
...
def bot(op):
  ...
  #-----------------=Selesai=------------------
            ...
            elif msg.text in ["PCI on","cancelinvite on"]:
              if msg.from_ in owner:
                if wait["Protectcancel"] == True:
                  if wait["lang"] == "JP":
            ...
            elif msg.text in ["PCI off","cancelinvite off"]:
              if msg.from_ in owner:
            ...
            elif msg.text in ["PH on","purge on","Purge: on","purge: on"]:
              if msg.from_ in admin:
                if wait["Protectjoin"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["PH off","purge off","Purge: off","purge: off"]:
              if msg.from_ in admin:
                if wait["Protectjoin"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["PC on","cancel on"]:
              if msg.from_ in owner:
                if wait["Protectcancl"] == True:
                    if wait["lang"] == "JP":
...
#---------------------Sc invite owner ke group------
        ...
        #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Responsename","86"]:
              if msg.from_ in owner:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                ka.sendText(msg.to,"Ready")
                cl.sendText(msg.to,"all Ready To Protect Group")
    #-------------Fungsi Respon Finish---------------------#   
            elif msg.text in ["Invite"]:
              if msg.from_ in owner:
                wait["winvite"] = True
                cl.sendText(msg.to,"kirim kontak crutt")
                
            elif msg.text in ["2invite"]:
              if msg.from_ in owner:
                wait["winvite2"] = True
                ki.sendText(msg.to,"kirim kontak crutt")
      ...
      #-------------Fungsi Balesan Respon Start---------------------#
                ...
                random.choice(KAC).sendText(msg.to,"a...daa ajaa😁😁")
    ...
    #-------------Fungsi Bannlist Finish------------------#  
              ...
              if msg.from_ in admin:
                ...
                van = "Bot sudah berjalan"+waktu(eltime)
