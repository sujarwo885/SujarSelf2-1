...
cl.login(token="EncKFBBwT240vCL3b7L4.v3159rqs/s56knnGYJuA5a.D4OuLGkxNtDtuwXLr8GadNDGwq4fQ9lFXJjircyl47E=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="EnFtiBfBUgI7Aa7wMBna.bDQP7xblQtYo/hfeBJ8dUG.JyeXZ45qkFYVKAIcVndJrWu8h8bH6aIA3AwHH3WSsjg=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="EnyxeoNaYkrtjrJ0pI26.WCqfVaPSGIEZU9MGO5FuDG.A4pfEOscu7/OmsgkyLvEDzuAfGE06DCcwnDFH3CUHZU=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="EnZ0QgapxJXQouRqNws9.cue8aJxnSJS8MtzA7c8o2q.V+zHZ3+VI25XMRIVMfJdY2dyoofXGzCe3LhIgAty4A8=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="EnqvpSttndtzjut2Fe6c.HAXaYczGV0xVj7BkGgemFa.X5AjLu+kiMDcnbpw0konn19f9dijF0WwMeG4Ncors6I=")
ks.loginResult()
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                ki.sendText(msg.to,"already on protect")
                kk.sendText(msg.to,"already on protect")
                kc.sendText(msg.to,"already on protect")
                ks.sendText(msg.to,"already on protect")
                ka.sendText(msg.to,"already on protect")
