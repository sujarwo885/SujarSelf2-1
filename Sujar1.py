...
import time, random, sys, ast, re, os, io, json, subprocess, threading, string, codecs, requests, tweepy, ctypes, urllib, urllib2, wikipedia
import timeit
...
#==============================================================================#
            elif "Nice" in msg.text:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Nice","")
