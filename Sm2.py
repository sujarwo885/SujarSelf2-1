...
#􀰂􀰂􀰂􀰂bot1
ki = LINETCR.LINE()
ki.login(token="EoXu9UATMbVAhdeHUTf9.n3yzvyKPlWSEmc56k5Dj6q./HjpwFlNiFAQsR1ZfjgB3CkVeIRxVxgqic+6iSVsBxg=")
ki.loginResult()
#􀰂􀰂􀰂􀰂bot2
ks = LINETCR.LINE()
ks.login(token="EolmyFkLac4Wgui5aAY6.0yhh1m1YeFiSiiw9XPZH1G.QmRhbc9IlRoapG+tUZSxEXuog2wep6ekACvB1OtDPLs=")
ks.loginResult()
#􀰂􀰂􀰂􀰂bot3
kt = LINETCR.LINE()
kt.login(token="EoH3Tt0wLw2c8FnAI7U4.rRhTH/Cyo1VIflImCYO/ba.JUa8ttckvWIYJ8ZHVuNf7Xz4DdQqRC00skJa+uWVMBM=")
kt.loginResult()
#􀰂􀰂􀰂􀰂bot4
kk = LINETCR.LINE()
kk.login(token="EosHq9QVcdn3S8dYFIoe.dOEyacJ4DGHwo1E1Uh0YpG.Q3QcfUtdFkA52C7IICXY7UPXLj50Ezv9540lsHCELL8=")
kk.loginResult()
#􀰂􀰂􀰂􀰂bot5
kc = LINETCR.LINE()
kc.login(token="Eos18omWQUNOeY40ssI2.lfqattBPKcf6dYuOZXQhSG.Uf2YY3zD8KmJQAQOpZV/63gDQ6JFDYCqixkqG9GPxyY=")
kc.loginResult()
#Kicker-01
kl = LINETCR.LINE()
kl.login(token="Eo8ml4kgVBqCN6xiwtAc.HAXaYczGV0xVj7BkGgemFa.s9CHWe09mVvsGe+oYpT++sxKLA+xaeNs3QkR0RI4/Hw="")
kl.loginResult()
#Kicker-02
kl1 = LINETCR.LINE()
kl1.login(token="EoEn5rjls1wIsEFby57a.DHeHozIH2dDZH7qBMF5JwG.NkF00Qa3Wkgfy3gWhpiJgSrW1w66IYqc8hoZ55nQoY4=")
kl1.loginResult()
#Kicker-03#
#kl2 = LINETCR.LINE()
#kl2.login(token="EoqbAfuSagP6TIwE3H9a.FJejU2LAd9gmRvON0u7DAG.c/9q4uEN/lgsRXYk48aRCgBZ4veIVAtkxKPSKxfGc3A=")
#kl2.loginResult()

print "Rangers-SelfBot Succes Login"
reload(sys)
...
║[★]● Turn off bots
●▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬●
 ●▬ஜ۩Rangers Squad Team۩ஜ▬●
●▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬●
""
KAC=[cl,ki,kk,kc,ks,kt,kl,kl1]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
Bmid = ks.getProfile().mid
Cmid = kt.getProfile().mid
Dmid = kk.getProfile().mid
Emid = kc.getProfile().mid
Fmid = kl.getProfile().mid
Gmid = kl1.getProfile().mid
#Hmid = kl2.getProfile().mid
protectname = []
protecturl = []
protection = []
autocancel = {}
...
admin = [mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid]
owner = [mid]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks for add Me By [☪Rangers☪]",
    "lang":"JP",
    "comment":"Auto Like By [☪Rangers☪]",
...
#======================================================
                ...
                if op.param3 in Bmid:
                    if op.param2 in Emid:
                        ...
                        G.preventJoinByTicket = True
                        kt.updateGroup(G)
                        Ticket = k.reissueGroupTicket(op.param1)
#=========================================================================
              ...
              if msg.from_ in admin:
                if wait["protectionOn"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"turned into high protection\n\n"+ datetime.today().strftime('%H:%M:%S'))
            elif msg.text in ["Auto blockqr:off","Qr:off"]:
              if msg.from_ in admin:
                if wait["qr"] == False:
                    if wait["lang"] == "JP":
              ...
              if msg.from_ in admin:
                if wait["welcomemsg"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"welcome message on")
            elif msg.text in ["Auto blockqr:on","Qr:on"]:
              if msg.from_ in admin:
                if wait["qr"] == True:
                    if wait["lang"] == "JP":
...
#============================================================
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
#=======================================================
            elif msg.text in ["Auto notice:on","Notice:on"]:
              if msg.from_ in admin:
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
...
#=========================================================================
            elif msg.text in ["Auto notice:off","Notice:off"]:
              if msg.from_ in admin:
...
#========================================
            elif msg.text in ["Team @join","Join"]:
              if msg.from_ in admin:
...
#=====================================================================================
            ...
            elif msg.text in ["Bye allgroups","Pamit"]:
              if msg.from_ in admin:
				gid = cl.getGroupIdsJoined()
				for i in gid:
					ki.leaveGroup(i)
...
#============================================
            ...
            elif msg.text.lower() in [".","Tagall","Mention"]:
              if msg.from_ in admin:
                group = cl.getGroup(msg.to)
...
#------------------------------------------------------------------------------------
        if op.type == 32:
			OWN = mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid
			if op.param2 in Bots and admin:
				pass
			else:
				Inviter = op.param3.replace("",',')
